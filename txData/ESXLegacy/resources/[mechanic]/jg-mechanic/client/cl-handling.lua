...
function setVehicleHandlingValue(vehicle, fieldName, value)
  if string.sub(fieldName, 1, 3) == "vec" then -- is vec
    return SetVehicleHandlingVector(vehicle, "CHandlingData", fieldName, vector3(value.x, value.y, value.z))
  elseif string.sub(fieldName, 1, 1) == "n" then -- is int
    return SetVehicleHandlingInt(vehicle, "CHandlingData", fieldName, value --[[@as integer]])
  else
    return SetVehicleHandlingFloat(vehicle, "CHandlingData", fieldName, value + 0.0 --[[@as number]])
  end
end
